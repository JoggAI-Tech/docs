...
<Tip>
**Recommended Approach**: Use [Webhooks](/api-reference/v2/API Documentation/WebhookIntegration) instead of polling for better performance and user experience.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/api-reference/v2/API Documentation/ErrorCodes"
  >
  ...
  <Card
    title="Rate Limits"
    icon="gauge"
    href="/api-reference/v2/API Documentation/RateLimits"
  >
    API usage limits
  </Card>
</CardGroup>
