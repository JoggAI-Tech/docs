...
| **Product Videos** | `GET /product_video/{product_video_id}` | [API Reference](/api-reference/v2/Video/GetProductVideo) |
| **Template Videos** | `GET /template_video/{video_id}` | [API Reference](/api-reference/v2/Video/GetTemplateVideo) |
