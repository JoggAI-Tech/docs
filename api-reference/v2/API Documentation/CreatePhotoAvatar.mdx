...
<Tip>
Avatar generation typically takes 2-5 minutes. Use [Webhooks](/api-reference/v2/API Documentation/WebhookIntegration) for instant notifications instead of polling. See [Webhook Mode](#webhook-mode) section below for complete setup.
</Tip>
...
See [Webhook Integration Guide](/api-reference/v2/API Documentation/WebhookIntegration) for complete webhook documentation.
</Info>
