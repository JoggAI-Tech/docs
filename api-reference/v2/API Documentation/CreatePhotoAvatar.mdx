...
|--------|----------|-------------|
| POST | `/open/v2/photo_avatar/photo/generate` | Generate photo avatar |
| GET | `/open/v2/photo_avatar/photo` | List your photo avatars |
| GET | `/open/v2/photo_avatar/photo/{id}` | Get specific avatar status |
| POST | `/open/v2/photo_avatar/add_motion` | Add motion to avatar |
...
```bash
curl --request POST \
  --url 'https://api.jogg.ai/open/v2/photo_avatar/photo/generate' \
...
```bash
curl --request GET \
  --url 'https://api.jogg.ai/open/v2/photo_avatar/photo' \
  --header 'x-api-key: YOUR_API_KEY'
```
...
```bash
curl --request POST \
  --url 'https://api.jogg.ai/open/v2/photo_avatar/add_motion' \
  --header 'x-api-key: YOUR_API_KEY' \
  --header 'Content-Type: application/json' \
  --data '{
    "avatar_id": 123,
...
```bash
curl --request GET \
  --url 'https://api.jogg.ai/open/v2/photo_avatar/add_motion?task_id=motion_xyz789' \
  --header 'x-api-key: YOUR_API_KEY'
```
