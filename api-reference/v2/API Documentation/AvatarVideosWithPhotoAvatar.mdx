...
<Info>
**Prerequisites:** You must first create a photo avatar before using it in videos. See [Create Photo Avatar](/api-reference/v2/API%20Documentation/CreatePhotoAvatar) guide.
</Info>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="camera"
    href="/api-reference/v2/API%20Documentation/CreatePhotoAvatar"
  >
