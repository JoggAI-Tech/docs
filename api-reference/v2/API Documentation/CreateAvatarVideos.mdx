...
<CardGroup cols={3}>
  <Card
    title="With Photo Avatar"
    icon="camera"
    href="/api-reference/v2/API Documentation/AvatarVideosWithPhotoAvatar"
  >
    Use custom photo avatars
  </Card>
  
  <Card
    title="Transparent Background"
    icon="circle"
    href="/api-reference/v2/API Documentation/AvatarVideosTransparentBackground"
  >
    Videos with transparent BG
  </Card>
  
  <Card
    title="With Audio Source"
    icon="waveform"
    href="/api-reference/v2/API Documentation/AvatarVideosWithAudioSource"
  >
