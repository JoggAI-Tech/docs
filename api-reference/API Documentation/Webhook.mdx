...
When configuring a webhook, you must provide a secret key. This secret is used to sign webhook payloads, allowing you to verify that requests are coming from Jogg.
...
7. Store webhook logs for security auditing
