...
First, create your Photo Avatar on the [Create photo Avatar page](https://app.jogg.ai/create-photo-avatar). Then, use the `My Photo Avatars` List endpoint to obtain your Avatar ID, and the `My Voices List` endpoint to retrieve your Voice for video creation.
