...
1. [******Upload Existing Photos or Generate New AI Avatar Photos:******](https://www.joggai.cn/) You can upload a set of your own photos or generate new AI photos.
2. **Create New Looks for the Avatar:** You can use prompts to generate various "looks" for the avatar, such as different clothing, scenes, or poses. This is done within the trained Avatar Group, giving you diverse outputs.
3. [**Add Motion Programmatically**](https://docs.h)**:** You can enhance the avatars by adding dynamic motion programmatically. This includes enabling the avatar to move and adding audio to bring the avatar to life.
...
[<u>See detailed API reference</u>](https://docs.)
...
[See detailed API reference](https://docs.)
...
[<u>See detailed API reference</u>](https://do)
...
[See detailed API reference](https://docs.he)
...
[<u>See detailed API reference</u>](https://doc)
