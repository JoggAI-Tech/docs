...
description: "Understand Jogg Remote MCP OAuth, Space selection, resource-bound tokens, redirect URIs, and tool scopes."
---

Jogg Remote MCP uses OAuth 2.0 Authorization Code with PKCE. The browser flow
...
| `voice.generate` | Submit and inspect speech synthesis or transcription jobs |
